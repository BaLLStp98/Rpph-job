  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const resumePayload = {
        ...
        // การทำงานราชการก่อนหน้า
        previousGovernmentService: (formData.previousGovernmentService || []).map((p) => ({
          position: p.position,
        ...
        staff_department: formData.staffInfo?.department || null,
        staff_start_work: formData.staffInfo?.startWork || null,
        // เอกสารแนบ - ส่งข้อมูล documents ไปยัง API
        documents: formData.documents ? Object.entries(formData.documents)
          ...
          .map(([docType, file]) => {
            if (Array.isArray(file)) {
              // สำหรับไฟล์หลายไฟล์
              return file.map(f => {
                const actualFile = (f as any)?.file || f;
                return {
                  documentType: docType.toUpperCase().replace(/([A-Z])/g, '_$1').substring(1),
                  fileName: actualFile?.name || '',
                  filePath: null,
                  fileSize: actualFile?.size || null,
                  mimeType: actualFile?.type || null
                };
              });
            } else {
              // สำหรับไฟล์เดียว
      ...
      if (formData.profileImage && saved?.id) {
        try {
          const imageFormData = new FormData();
          imageFormData.append('file', formData.profileImage);
          imageFormData.append('resumeId', saved.id);
          ...
          if (imageResponse.ok) {
            ...
            console.log('✅ Profile image uploaded successfully:', imageResult);
            
            // อัปเดต profileImageUrl ในฐานข้อมูล
            const updateResponse = await fetch(`/api/resume-deposit/${saved.id}`, {
              method: 'PATCH',
              headers: { 'Content-Type': 'application/json' },
              body: JSON.stringify({ profileImageUrl: imageResult.profileImage })
            });
      ...
      const prismaData = {
        ...
        // Documents data
        documents: applicationData.documents ? Object.entries(applicationData.documents)
          .filter(([_, fileName]) => fileName)
          .map(([docType, fileName]) => ({
            documentType: docType.toUpperCase().replace(/([A-Z])/g, '_$1').substring(1),
            fileName: typeof fileName === 'string' ? fileName : (fileName as any)?.name || ''
          })) : []
      };
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800">กรอกข้อมูลสมัครงาน</h1>
              ...
              <div className="mb-8">
                      ...
                      <div className="mt-4 p-4 border border-gray-200 rounded-lg bg-white">
                        ...
                        <div className="space-y-4">
                          <div className="space-y-2">
                            ...
                            <input
                              type="text"
                              value={formData.spouseInfo?.firstName && formData.spouseInfo?.lastName 
                                ? `${formData.spouseInfo.firstName} ${formData.spouseInfo.lastName}` 
                                : ''}
                              onChange={(e) => {
                                ...
                                handleInputChange('spouseInfo.firstName', firstName);
                                handleInputChange('spouseInfo.lastName', lastName);
                              }}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('registeredAddress.houseNumber', e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('registeredAddress.villageNumber', e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('registeredAddress.subDistrict', e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('registeredAddress.district', e.target.value)}
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('registeredAddress.province', e.target.value)}
                        placeholder="กรอกจังหวัด"
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:border-transparent ${
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('registeredAddress.postalCode', e.target.value)}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('currentAddressDetail.houseNumber', e.target.value)}
                        placeholder="กรอกเลขที่"
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:border-transparent ${
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('currentAddressDetail.villageNumber', e.target.value)}
                        placeholder="กรอกหมู่ที่"
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:border-transparent ${
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('currentAddressDetail.subDistrict', e.target.value)}
                        placeholder="กรอกตำบล/แขวง"
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:border-transparent ${
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('currentAddressDetail.district', e.target.value)}
                        placeholder="กรอกอำเภอ/เขต"
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:border-transparent ${
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('currentAddressDetail.province', e.target.value)}
                        placeholder="กรอกจังหวัด"
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:border-transparent ${
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('currentAddressDetail.postalCode', e.target.value)}
                        placeholder="กรอกรหัสไปรษณีย์"
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:border-transparent ${
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('currentAddressDetail.homePhone', e.target.value)}
                        placeholder="กรอกเบอร์โทรศัพท์บ้าน"
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('currentAddressDetail.mobilePhone', e.target.value)}
                        placeholder="กรอกเบอร์โทรศัพท์มือถือ"
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:border-transparent ${
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) => handleInputChange('emergencyAddress.subDistrict', e.target.value)}
                            placeholder="กรอกตำบล/แขวง"
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) => handleInputChange('emergencyAddress.district', e.target.value)}
                            placeholder="กรอกอำเภอ/เขต"
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) => handleInputChange('emergencyAddress.province', e.target.value)}
                            placeholder="กรอกจังหวัด"
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) => handleInputChange('emergencyAddress.postalCode', e.target.value)}
                            placeholder="กรอกรหัสไปรษณีย์"
                    ...
                    <div className="border-t pt-4">
                      <h5 className="text-sm font-medium text-gray-700 mb-3">ข้อมูลสถานที่ทำงานผู้ติดต่อฉุกเฉิน</h5>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) => handleInputChange('emergencyWorkplace.district', e.target.value)}
                            placeholder="กรอกอำเภอ/เขต"
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) => handleInputChange('emergencyWorkplace.province', e.target.value)}
                            placeholder="กรอกจังหวัด"
