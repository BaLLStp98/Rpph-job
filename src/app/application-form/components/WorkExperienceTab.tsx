...
interface WorkExperienceTabProps {
  ...
  parseDateFromThai: (thaiDate: string) => string;
  workStartRefs: React.MutableRefObject<(HTMLInputElement | null)[]>;
  workEndRefs: React.MutableRefObject<(HTMLInputElement | null)[]>;
}
